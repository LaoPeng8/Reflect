...
/**
 * 测试发送简单邮件 (简单邮件就是 只有收件人,发件人,标题,正文) (复杂文件就是 在简单邮件的基础上 加上了附件,图片等)
 * @author PengJiaJun
 */
...
//        message.setRecipient(MimeMessage.RecipientType.BCC,new InternetAddress(mReceiveAddress,"密送人C","utf-8"));
        ...
        message.setSubject("这是标题","utf-8");//设置标题
        message.setContent("这是邮件正文,,HelloWorld...","text/html;charset=utf-8");//设置邮件正文.
